...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.conezi.face_camera.FaceCameraPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin face_camera, com.conezi.face_camera.FaceCameraPlugin", e);
    }
    try {
